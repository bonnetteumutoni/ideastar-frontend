      ...
      <div className="flex h-screen font-sans">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
          <div className="w-full max-w-md">
            <h1 className="text-3xl font-bold mb-9" style={{ color: '#2F5A2B', ...inknutStyle }}>Welcome Back</h1>
            ...
            <p className="mt-8 text-center text-sm text-gray-600"  style={{ ...inknutStyle }}>
              ...
              <Link href="/signup-page" className="font-medium hover:underline" style={{ color: '#AC7A15',...inknutStyle  }}>
                Sign Up
              </Link>
            </p>
          </div>
